...
namespace Adjacency
{
    class Program
    {
        static int numVertices = 63;
        //Initialising Adjacency List
        static WeightedEdge[] adjacencyList = new WeightedEdge[numVertices];

        //Initalising edges array
        static WeightedEdge[] edges = new WeightedEdge[numVertices];

        //Initialising Dist To array and setting all values to max
        static int[] distTo = new int[numVertices];
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("*********");
                Console.WriteLine("");
                Console.WriteLine("1. Calculate Path");
                Console.WriteLine("2. Add Delay");
                Console.WriteLine("3. Print Delays");
                Console.WriteLine("");
                ...
                switch (choice)
                {
                    case 1:
                        {
                            ...
                            //Check source and destination are valid entries
                            for (int i = 0; i < 64; i++)
                            {
                                if (i == 63)
                                {
                                    Console.WriteLine("Please enter a valid start station, note that input is case sensitive");
                                    break;
                                }
                                if (source == adjacencyList[i].Source)
                                {
                                    break;
                                }
                            }
                            ...
                            for (int i = 0; i < 64; i++)
                            {
                                if (i == 63)
                                {
                                    Console.WriteLine("Please enter a valid destination station, note that input is case sensitive");
                                    break;
                                }
                                if (destination == adjacencyList[i].Source)
                                {
                                    break;
                                }
                            }
                            ...
                            WeightedEdge[] result = Dijkstra.DijkstraMethod(source, destination, adjacencyList, edges, distTo);

                            for (int i = 0; i < count; i++)
                            {
                                Console.WriteLine(delays[i]);
                            }
                    ...
                    case 2:
                        {
                            Console.WriteLine("Enter the two adjacent station between which the delay needs to be added");
                            Console.WriteLine("Station 1: ");
                            station1 = Console.ReadLine();
                            Console.WriteLine("Station 2: ");
                            station2 = Console.ReadLine();
                            Console.WriteLine("Reason: ");
                            delayReason = Console.ReadLine();
                            Console.WriteLine("Time to be added: ");
                            delayTime = Console.ReadLine();
                            delays[count] = "Currently delays between " + station1 + " and " + station2 + " due to " + delayReason + ". " + "Time to be added: " + delayTime; 
                            count++;
