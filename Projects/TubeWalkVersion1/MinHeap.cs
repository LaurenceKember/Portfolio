//adapted from
//Week 8 Tutorial Exercises: Heaps 
...
namespace TubeWalkVersion1
{
    public class MinHeap
    {
        ...
        private HeapItem[] heap;                    // array of HeapItems i.e. the Heap itself
        ...
        // mapping the child to the parent - see lecture week 8 for explanation of formulas here
